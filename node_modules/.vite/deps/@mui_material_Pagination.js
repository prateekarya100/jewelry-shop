import {
  ButtonBase_default
} from "./chunk-ZRUEOKCY.js";
import "./chunk-U2S672ZN.js";
import "./chunk-X7RJIM5X.js";
import {
  createSimplePaletteValueFilter
} from "./chunk-KSVZAH5Y.js";
import "./chunk-DEHSPOAI.js";
import "./chunk-YQE5XQZY.js";
import "./chunk-PGFUDP4X.js";
import {
  useControlled
} from "./chunk-WMH3AE4L.js";
import "./chunk-RDVAODNE.js";
import "./chunk-ZIZIHT6H.js";
import "./chunk-XNOKKL7M.js";
import "./chunk-YMCHUJCS.js";
import "./chunk-K5FRJPI2.js";
import "./chunk-DHNYWEOK.js";
import "./chunk-C3GGO34Q.js";
import "./chunk-5EPWDMCH.js";
import "./chunk-4HTMBLKZ.js";
import {
...
var Pagination = React2.forwardRef(function Pagination2(inProps, ref) {
  ...
  const paginationRef = React2.useRef(null);
  const pendingFocusRef = React2.useRef(null);
  const handleRef = useForkRef_default(ref, paginationRef);
  const selectedPage = (_a = items.find((item) => item.selected)) == null ? void 0 : _a.page;
  const handleItemClick = React2.useCallback((item, event) => {
    ...
    if (willBecomeDisabled && getActiveElement_default(ownerDocument_default(event.currentTarget)) === event.currentTarget) {
  ...
  useEnhancedEffect_default(() => {
    ...
    const document = ownerDocument_default(paginationRef.current);
    const activeElement = getActiveElement_default(document);
    if (activeElement === document.body || activeElement === document.documentElement || activeElement === pending.trigger || activeElement == null) {
      (_a2 = paginationRef.current.querySelector('[aria-current="page"]')) == null ? void 0 : _a2.focus();
    }
    pendingFocusRef.current = null;
  }, [selectedPage]);
