...
var Tooltip = React3.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const openedByDisabledTriggerRef = React3.useRef(false);
  ...
  const handleTriggerMouseOver = (event) => {
    if ((childNode == null ? void 0 : childNode.disabled) && !isControlled) {
  ...
  const handleInteractiveWrapperMouseOver = (event) => {
    if ((childNode == null ? void 0 : childNode.disabled) && !isControlled && !openedByDisabledTriggerRef.current) {
      return;
    }
    handleMouseOver(event);
  };
