import {
  useRadioGroup
} from "./chunk-37OZ3QUT.js";
import {
  getRadioUtilityClass,
  radioClasses_default
} from "./chunk-VB5S6VCC.js";
import {
  useFormControl
...
var RadioRoot = styled_default(SwitchBase_default, {
  ...
  ...theme.focusVisible && {
    [`&.${buttonBaseClasses_default.focusVisible} svg:first-of-type`]: {
      ...outsetFocusRing,
      borderRadius: 99,
      ...theme.focusVisible
    }
...
var Radio = React2.forwardRef(function Radio2(inProps, ref) {
  ...
  const [RootSlot, rootSlotProps] = useSlot("root", {
    ...
    additionalProps: {
      ...
      checkedIcon: React2.cloneElement(checkedIcon, {
