...
export default function TrustStrip() {
  return (
    <Box id="story" sx={{ bgcolor: 'background.paper', py: { xs: 6, md: 8 } }}>
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: { xs: 5, md: 6.5 } }}>
          <Typography sx={{
            fontSize: 12, fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase',
            color: 'secondary.dark', mb: 1.5,
          }}>
            Why shop with us
          </Typography>
          <Typography variant="h3" sx={{ fontSize: { xs: 26, sm: 32, md: 40 }, lineHeight: 1.18 }}>
            Made to be trusted.
            <Box component="span" sx={{ display: 'block' }}>
              <Box component="em" sx={{ fontStyle: 'italic', color: 'secondary.dark' }}>
