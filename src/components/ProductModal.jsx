      ...
      <DialogContent sx={{ p: 0 }}>
        <Grid container>
          ...
          <Grid size={{ xs: 12, md: 6 }} sx={{ p: { xs: 2.5, md: 4 } }}>
            ...
            />
            <Typography variant="h4" sx={{ fontSize: { xs: 23, md: 28 }, mt: 1 }}>{product.title}</Typography>
            ...
            <Stack direction="row" spacing={1.5} flexWrap="wrap" rowGap={1.5} sx={{ mt: 3 }}>
              ...
              <Button variant="contained" color="primary" size="large" onClick={() => onAddToCart(product.id, qty)} sx={{ flex: '1 1 200px' }}>
            ...
            <Box component="form" onSubmit={submitReview} sx={{ mt: 1.5, p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 1, bgcolor: 'background.paper' }}>
              ...
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} alignItems={{ xs: 'stretch', sm: 'center' }} sx={{ mb: 1.5 }}>
                ...
                <Rating
                  ...
                  sx={{ color: 'secondary.main', whiteSpace: 'nowrap', alignSelf: { xs: 'flex-start', sm: 'center' } }}
                />
              </Stack>
              <TextField
