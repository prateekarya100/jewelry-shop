    ...
    >
      ...
      <DialogContent sx={{ p: 0 }}>
        <Grid container>
          <Grid
            size={{ xs: 12, md: 6 }}
            sx={{ bgcolor: "#f2e2d8", p: { xs: 2.5, md: 3.5 } }}
          >
              ...
              {showVideo && product.video ? (
                <AspectMedia ratio="1 / 1">
                  {isYouTube(product.video) ? (
                    <Box
                      component="iframe"
                      src={toYouTubeEmbed(product.video)}
              ...
              {product.video && (
                <Box
                  ...
                  sx={{
                    ...
                    border: "2px solid",
                    borderColor: showVideo ? "secondary.main" : "transparent",
                  }}
                >
          ...
          <Grid size={{ xs: 12, md: 6 }} sx={{ p: { xs: 2.5, md: 4 } }}>
            ...
            >
              <Typography
                sx={{ fontWeight: 800, fontSize: 27, color: "primary.main" }}
              >
            ...
            <Typography
              variant="body2"
              sx={{ mt: 2.5, lineHeight: 1.65, color: "text.primary" }}
            >
              {product.description}
            </Typography>
            {product.material && (
