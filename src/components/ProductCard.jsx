    ...
    <Card
      sx={{
        ...
        "&:hover": {
          ...
          boxShadow: "0 24px 44px rgba(36,26,31,0.16)",
        },
    ...
    >
        ...
        <Box sx={{ position: "relative" }}>
          ...
          {outOfStock && (
            ...
            >
              <Chip
                label="Sold out"
                sx={{ bgcolor: "primary.main", color: "#fff", fontWeight: 800 }}
              />
            </Box>
          )}
        </Box>
          ...
          <Tooltip title={saved ? "Saved" : "Save for later"}>
            <IconButton
              ...
              sx={{
                ...
                width: 40,
                height: 40,
                boxShadow: "0 4px 12px rgba(36,26,31,0.18)",
                "&:hover": { bgcolor: "#fff" },
              }}
            >
              {saved ? (
      ...
      >
        ...
        <Stack
          ...
          alignItems="baseline"
          spacing={1}
          sx={{ mt: "auto", pt: 1.25, minWidth: 0, flexWrap: "wrap" }}
        >
          <Typography
            sx={{
              fontWeight: 800,
