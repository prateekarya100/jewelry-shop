  ...
  return (
    <Box component="footer" sx={{ bgcolor: 'primary.main', color: 'primary.contrastText', pt: 6, pb: 3, mt: 4 }}>
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', pb: { xs: 5, md: 6 }, mb: { xs: 5, md: 6 }, borderBottom: '1px solid rgba(250,241,236,0.12)' }}>
          <Typography variant="h3" sx={{ fontSize: { xs: 26, sm: 32, md: 40 }, lineHeight: 1.18, color: 'primary.contrastText' }}>
            Find the piece
        ...
        <Grid container spacing={4}>
          <Grid size={{ xs: 12, sm: 6, md: 4 }}>
            <Box
              ...
              sx={{ mb: 1.5, background: 'none', border: 0, p: 0, cursor: 'pointer', display: 'block' }}
            >
