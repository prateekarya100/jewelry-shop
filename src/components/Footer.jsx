      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            ...
            <Box component="span" sx={{ display: "block" }}>
              ...
              <Box
                component="em"
                sx={{ fontStyle: "italic", color: "secondary.light" }}
              >
                wear every day.
              </Box>
            </Box>
        ...
        <Grid container spacing={4}>
          <Grid size={{ xs: 12, sm: 6, md: 4 }}>
            ...
            <Typography
              variant="body2"
              sx={{ color: "rgba(250,241,236,0.65)" }}
            >
              Small-batch fine jewellery, made to be worn daily and kept for
              years.
            </Typography>
          </Grid>
          <Grid size={{ xs: 6, sm: 3, md: 4 }}>
            <FooterCol
              ...
              links={["Rings", "Necklaces", "Earrings", "Bangles"]}
            />
          </Grid>
          <Grid size={{ xs: 6, sm: 3, md: 4 }}>
            <FooterCol
        ...
        <Stack
          ...
          sx={{ mb: 1, width: "100%", maxWidth: "100%", flexWrap: "wrap" }}
        >
        ...
        <Stack
          ...
          rowGap={1}
          justifyContent="center"
          sx={{ mb: 2.5, width: "100%", maxWidth: "100%", flexWrap: "wrap" }}
        >
          {[
        ...
        <Stack
          ...
          sx={{ fontSize: 13, color: "rgba(250,241,236,0.55)" }}
        >
        ...
        <Typography
          ...
          sx={{
            ...
            textAlign: "center",
            mt: 2,
            color: "rgba(250,241,236,0.45)",
          }}
        >
          Designed and developed by{" "}
          <Box
            component="a"
            href="https://tomcatdevs.com"
            target="_blank"
            rel="noopener"
            sx={{
              color: "rgba(250,241,236,0.65)",
              "&:hover": { color: "#fff" },
            }}
          >
            tomcatdevs.com
