    ...
    >
      ...
      <Box
        sx={{
          ...
          height: 360,
          borderRadius: "50%",
          border: "1px solid rgba(184,112,63,0.18)",
          pointerEvents: "none",
              ...
              <Box>
                ...
                <Typography
                  ...
                  sx={{
                    mt: 3,
                    maxWidth: "42ch",
                    color: "rgba(250,241,236,0.68)",
                    fontSize: 16.5,
                    lineHeight: 1.65,
                  }}
                >
                  Every piece in this shop is photographed on real hands, filmed
                  up close so you can see how it catches light, and finished by
                  someone whose name we know.
                </Typography>
                <Stack
                  direction="row"
                  spacing={3}
                ...
                <Stack
                  direction="row"
                  spacing={3}
                  sx={{ mt: 5, rowGap: 1.5, flexWrap: "wrap" }}
                >
                  {REASSURANCE.map((r) => (
                    <Stack
                      key={r.text}
